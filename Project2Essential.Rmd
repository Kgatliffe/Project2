...
mfxboot(modform = ModelAnalysisProBIC, dist = "probit",
        data = testset)
```
So how good is this model really? Running error analysis on tenure numeric, tenure categorical, and log tenure alone, code has been removed for all but log Tenure and Tenure numeric. Tenure dummy less than six months actually had results between Tenure numeric and log Tenure.
